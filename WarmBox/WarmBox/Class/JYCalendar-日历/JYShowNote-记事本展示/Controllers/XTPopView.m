...
- (instancetype)initWithOrigin:(CGPoint)origin My_Width:(CGFloat)width My_Height:(CGFloat)height Type:(XTDirectionType)type Color:(UIColor *)color{
...
{
    if (!_tableView) {
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(10, 0, self.backGoundView.frame.size.width - 15, self.backGoundView.frame.size.height) style:UITableViewStylePlain];
